...
public class GLAccount {
    ...
    private String status;  // ✅ Newly added field
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(accountType, other.accountType) 
            && Objects.equals(billPolicy, other.billPolicy)
            ...
            && Objects.equals(glAccount, other.glAccount)
    ...
    public String toString() {
        return "GLAccount [id=" + id + ", businessCode=" + businessCode 
                + ", glAccount=" + glAccount 
